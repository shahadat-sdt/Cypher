...
import com.github.sdt.cypher.data.model.ChildPhoto
...
import com.github.sdt.cypher.utils.ConstFun.isNotificationServiceRunning
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.HiddenCameraUtils.canOverDrawOtherApps
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.HiddenCameraUtils.openDrawOverPermissionSetting
import com.github.sdt.cypher.utils.hiddenCameraServiceUtils.config.CameraFacing
import com.github.sdt.cypher.utils.ConstFun.openUseAccessSettings
import com.github.sdt.cypher.utils.checkForegroundApp.CheckPermission.hasUsageStatsPermission
import com.github.sdt.cypher.data.model.ChildRecording
...
import com.github.sdt.cypher.utils.ConstFun.isAddWhitelist
import com.github.sdt.cypher.utils.ConstFun.isAndroidM
import com.github.sdt.cypher.utils.ConstFun.openAccessibilitySettings
import com.github.sdt.cypher.utils.ConstFun.openNotificationListenerSettings
import com.github.sdt.cypher.utils.ConstFun.openWhitelistSettings
import com.github.sdt.cypher.utils.ConstFun.permissionRoot
import com.github.sdt.cypher.utils.ConstFun.showApp
import com.github.sdt.cypher.utils.Consts.CHILD_NAME
import com.github.sdt.cypher.utils.Consts.COMMAND_ADD_WHITELIST
import com.github.sdt.cypher.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY
import com.github.sdt.cypher.utils.Consts.COMMAND_ENABLE_ACCESSIBILITY_1
import com.github.sdt.cypher.utils.Consts.COMMAND_ENABLE_NOTIFICATION_LISTENER
import com.github.sdt.cypher.utils.Consts.COMMAND_GRANT_PERMISSION
import com.github.sdt.cypher.utils.Consts.DEVICE_NAME
import com.github.sdt.cypher.utils.Consts.INTERVAL
import com.github.sdt.cypher.utils.Consts.PERMISSION_USAGE_STATS
import com.github.sdt.cypher.utils.Consts.TIMER
import com.github.sdt.cypher.utils.async.AsyncTaskRunCommand
import com.github.sdt.cypher.utils.checkForegroundApp.CheckPermission.getModeManager
